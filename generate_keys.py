...
for key, value in config.items():
    ...
    if value['type'] == 'image':
        text = f"""<image x="380" y="380" width="320" height="320" xlink:href="../icons/{value['text']}" />"""
    elif value['type'] == 'text':
        text = f"""<text x="20%" y="35%" fill="#333333" font-size="{font_size}" font-family="CourierPrime-Regular" text-anchor="start" alignment-baseline="hanging">{value['text']}</text>"""
